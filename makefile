...
SOURCES = $(SRC_DIR)/graphe.c $(SRC_DIR)/tableauGraphe.c $(SRC_DIR)/parcoursGraphe.c $(SRC_DIR)/afficheGraphe.c $(SRC_DIR)/serialization.c $(SRC_DIR)/main.c $(SRC_DIR)/outils.c
